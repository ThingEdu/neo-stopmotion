...
| T-020 | Enter phải KẾT THÚC làm phim, không làm tiếp | python-dev | 🟢 DONE | app | - | Tái hiện: Enter trên màn kết quả ghép LẠI phim; Enter 2 lần lúc đang ghép chạy 2 ffmpeg. Thêm cờ _exporting + chặn _post_export ở AppController (bảo vệ cả nút ThingBot). Enter bỏ khỏi 'làm phim mới' trên SuccessPage → N. 136 test |
